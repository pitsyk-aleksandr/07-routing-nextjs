...
const NotesClient = () => {
  ...
  const {
    ...
    queryKey: ['notes', query, 'all', page],
    // функція запиту - асинхронна функція, яка виконує HTTP-запит і повертає дані.
    queryFn: async () => fetchNotesByTag(query, 'all', page),
  ...
  return (
    <div className={css.app}>
      ...
      {notes && notes.length > 0 && (
        <NoteList notes={notes} currentQuery={query} currentTag="all" />
      )}
      ...
      {isModalOpen && (
        <Modal onClose={closeModal}>
          <NoteForm onClose={closeModal} currentQuery={query} currentTag="all" />
        </Modal>
      )}
    </div>
  );
